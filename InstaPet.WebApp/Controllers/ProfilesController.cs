...
namespace InstaPet.WebApp.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            profile.Pets = await _context.Pets
                .Include(p => p.Owner)
                .Where(p => p.Owner.Id  == id).ToListAsync();
        ...
        public async Task<IActionResult> Create(
            [Bind("Name,Email,UserName,Country,Active,Id")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Email,UserName,Country,Active,Id")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
